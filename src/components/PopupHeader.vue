  ...
  <div class="va-popup__header">
    ...
    >
      ...
      >
        ...
        <path d="M34.4 42h-32L0 38.3 22.6 0l17.2 29.3H33L22.5 13V1.3v14.5L7.8 36.4h26.6a6.1 6.1 0 015.5-3.4 6.1 6.1 0 016.1 6.1 6.1 6.1 0 01-6.1 6.2 6.1 6.1 0 01-5.5-3.4zm2.4-2.9a3 3 0 003 3.1 3 3 0 003.1-3 3 3 0 00-3-3.1 3 3 0 00-3.1 3z" fill="#3ab982"/>
        <path d="M4.4 35.7L22.5 5 34 24h-6.4l-5-8.3v-5.4 5.4L10.8 35.7z" fill="#34495f"/>
        <g fill="#34495f" stroke="#34495f" stroke-width="1.2">
